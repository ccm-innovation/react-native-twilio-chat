...
const { TwilioChatMessages } = NativeModules;
...
class Message {
  constructor(props, channelSid) {
    ...
    this.dateUpdated = props.dateUpdatedAsDate
      ? new Date(props.dateUpdated)
      : null;
    this.lastUpdatedBy = props.lastUpdatedBy;
    this.attributes = props.attributes;
    this._channelSid = props._channelSid || channelSid;
  }
  ...
  setAttributes(attributes) {
    return TwilioChatMessages.setAttributes(
      this._channelSid,
      this.index,
      attributes
    );
