...
<<<<<<< HEAD
        console.log('[createchannel] parsedOptions = ', parsedOptions)
        return TwilioIPMessagingChannels.createChannel(parsedOptions)
        .then((channel) => {
            console.log('channel created before new channel = ', channel)
            let c = new Channel(channel)
            c.initialize()
            console.log('new channel = ', c)
            return c
=======
        return TwilioIPMessagingChannels.createChannel(parsedOptions)
        .then((channel) => {
