...
class Channel {
    ...
    getUnconsumedMessagesCount() {
        return TwilioIPMessagingChannels.getUnconsumedMessagesCount(this.sid)
    }

    getMessagesCount() {
        return TwilioIPMessagingChannels.getMessagesCount(this.sid)
    }

    getMembersCount() {
        return TwilioIPMessagingChannels.getMembersCount(this.sid)
    }
